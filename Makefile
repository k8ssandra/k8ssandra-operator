...
# Runs e2e tests using two GKE.
# The clusters must be up and running and your ~/.kube/config file must contain the corresponding
# contexts.
gke-e2e-test:
	$(MAKE) e2e-test TEST_ARGS="-kubeconfigFile=$(HOME)/.kube/config -testProfile=gke -controlPlane=gke-k8ssandra-0 -dataPlanes=gke-k8ssandra-0,gke-k8ssandra-1"
