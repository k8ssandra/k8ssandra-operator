...
//+kubebuilder:rbac:groups=k8ssandra.io.k8ssandra.io,resources=k8ssandraclusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=k8ssandra.io.k8ssandra.io,resources=k8ssandraclusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=k8ssandra.io.k8ssandra.io,resources=k8ssandraclusters/finalizers,verbs=update
...
func (r *K8ssandraClusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&k8ssandraiov1alpha1.K8ssandraCluster{}).
		Complete(r)
}
