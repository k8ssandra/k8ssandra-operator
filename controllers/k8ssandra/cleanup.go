...
func (r *K8ssandraClusterReconciler) checkDeletion(ctx context.Context, kc *api.K8ssandraCluster, logger logr.Logger) result.ReconcileResult {
	...
	for _, dcTemplate := range kc.Spec.Cassandra.Datacenters {
		...
		selector := k8ssandralabels.MapOf(k8ssandralabels.CleanedUpByK8ssandraCluster(kcKey))
...
func (r *K8ssandraClusterReconciler) deleteK8ssandraConfigMaps(
	...
	selector := k8ssandralabels.MapOf(k8ssandralabels.CleanedUpByK8ssandraCluster(client.ObjectKey{Namespace: kc.Namespace, Name: kc.SanitizedName()}))
