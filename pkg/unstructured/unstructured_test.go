...
func TestUnstructured_GetNested(t *testing.T) {
	nilMap := Unstructured(nil)
	tests := []struct {
		name      string
		in        *Unstructured
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, gotFound := tt.in.GetNested(tt.path)
			assert.Equal(t, tt.want, got)
...
func TestUnstructured_PutNested(t *testing.T) {
	nilMap := Unstructured(nil)
	tests := []struct {
		name string
		in   *Unstructured
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.in.PutNested(tt.path, tt.v)
			assert.Equal(t, tt.want, tt.in)
		})
	}
}

func TestUnstructured_PutIfAbsentNested(t *testing.T) {
	nilMap := Unstructured(nil)
	tests := []struct {
		name string
		in   *Unstructured
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.in.PutNestedIfAbsent(tt.path, tt.v)
			assert.Equal(t, tt.want, tt.in)
		})
	}
}
