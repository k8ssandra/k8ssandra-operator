		...
		},
		{
			...
			config: api.CassandraConfig{
				CassandraYaml: api.CassandraYaml{
					...
					RpcKeepalive:                           pointer.Bool(true),
					RpcMaxThreads:                          pointer.Int(226),
					RpcMinThreads:                          pointer.Int(227),
					RpcRecvBuffSizeInBytes:                 pointer.Int(229),
					RpcSendBuffSizeInBytes:                 pointer.Int(230),
			...
			want: `{
				"cassandra-yaml": {
					...
					"rpc_max_threads": 226,
					"rpc_min_threads": 227,
					"rpc_recv_buff_size_in_bytes": 229,
					"rpc_send_buff_size_in_bytes": 230,
