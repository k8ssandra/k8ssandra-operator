...
func AddOrUpdateVolume(podTemplateSpec *corev1.PodTemplateSpec, volume *corev1.Volume, volumeIndex int, found bool) {
	if !found {
		...
		podTemplateSpec.Spec.Volumes[volumeIndex] = *volume
	}
}
