...
func (_m *ReaperManager) ConnectWithReaperRef(ctx context.Context, reaperRef v1.ObjectReference, username string, password string) error {
	ret := _m.Called(ctx, reaperRef, username, password)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, v1.ObjectReference, string, string) error); ok {
		r0 = rf(ctx, reaperRef, username, password)
	} else {
		r0 = ret.Error(0)
	}
