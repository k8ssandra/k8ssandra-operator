...
func (in *K8ssandraClusterStatus) DeepCopyInto(out *K8ssandraClusterStatus) {
	*out = *in
	if in.Datacenters != nil {
		in, out := &in.Datacenters, &out.Datacenters
		*out = make(map[string]K8ssandraDatacenterStatus, len(*in))
		for key, val := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8ssandraDatacenterStatus) DeepCopyInto(out *K8ssandraDatacenterStatus) {
	*out = *in
	if in.Cassandra != nil {
		in, out := &in.Cassandra, &out.Cassandra
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8ssandraDatacenterStatus.
func (in *K8ssandraDatacenterStatus) DeepCopy() *K8ssandraDatacenterStatus {
	if in == nil {
		return nil
	}
	out := new(K8ssandraDatacenterStatus)
	in.DeepCopyInto(out)
	return out
}
