...
JMX authorization is supported since k8ssandra-operator v1.5.0 through the use of Cassandra internals. However, K8ssandra does not currently support configuring JMX authorization.
