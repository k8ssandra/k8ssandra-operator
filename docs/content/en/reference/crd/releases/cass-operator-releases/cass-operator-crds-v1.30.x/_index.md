---
title: "cass-operator CRDs vv1.30.x"
linkTitle: "cass-operator CRDs vv1.30.x"
weight: 5
description: >
  Configuration reference for the CRDs used with cass-operator vv1.30.x.  
---
...
they will join together in a multi-datacenter cluster.<br/>
        </td>
        <td>true</td>
      </tr><tr>
...
used to generate Cassandra server configuration<br/>
        </td>
        <td>true</td>
      </tr><tr>
        <td><b>size</b></td>
...
Avoid label "cass-operator" and anything that starts with "cassandra.datastax.com/"<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
option on in which case the defaults are not set.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
the first rack of the datacenter<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
either 0 or greater than the rack size, then all nodes in the rack will get updated.<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
...
that an update to the secret will trigger an update of the StatefulSets.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
Use cautiously.<br/>
        ...
        <td>boolean</td>
        <td>
          DEPRECATED This setting does nothing and defaults to true. Use SecurityContext instead.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
More info: https://kubernetes.io/docs/concepts/configuration/assign-pod-node/#nodeselector<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
to false once the restart is in progress.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
setting it in the PodTemplateSpec.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>stopped</b></td>
...
will re-attach when the CassandraDatacenter workload is resumed.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
If it is omitted, we will generate a secret instead.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath<br/>
        ...
        <td><b><a href="#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesourceimage">image</a></b></td>
        <td>object</td>
        <td>
...
#### CassandraDatacenter.spec.storageConfig.additionalVolumes[index].volumeSource.image
<sup><sup>[↩ Parent](#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesource)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesourceprojectedsourcesindexclustertrustbundle">clusterTrustBundle</a></b></td>
        <td>object</td>
        <td>
...
may change the order over time.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesourceprojectedsourcesindexpodcertificate">podCertificate</a></b></td>
        <td>object</td>
        <td>
...
#### CassandraDatacenter.spec.storageConfig.additionalVolumes[index].volumeSource.projected.sources[index].clusterTrustBundle
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesourceprojectedsourcesindexclustertrustbundlelabelselector">labelSelector</a></b></td>
        <td>object</td>
        <td>
...
#### CassandraDatacenter.spec.storageConfig.additionalVolumes[index].volumeSource.projected.sources[index].clusterTrustBundle.labelSelector
<sup><sup>[↩ Parent](#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesourceprojectedsourcesindexclustertrustbundle)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesourceprojectedsourcesindexclustertrustbundlelabelselectormatchexpressionsindex">matchExpressions</a></b></td>
        <td>[]object</td>
        <td>
          matchExpressions is a list of label selector requirements. The requirements are ANDed.<br/>
        </td>
...
#### CassandraDatacenter.spec.storageConfig.additionalVolumes[index].volumeSource.projected.sources[index].clusterTrustBundle.labelSelector.matchExpressions[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecstorageconfigadditionalvolumesindexvolumesourceprojectedsourcesindexclustertrustbundlelabelselector)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecconfigbuilderresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
...
#### CassandraDatacenter.spec.configBuilderResources.claims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecconfigbuilderresources)</sup></sup>
...
More info: https://git.k8s.io/enhancements/keps/sig-network/580-pod-readiness-gates<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecresourceclaimsindex">resourceClaims</a></b></td>
        <td>[]object</td>
        <td>
...
This field is immutable.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecresources">resources</a></b></td>
        <td>object</td>
        <td>
...
If not specified, the pod will be dispatched by default scheduler.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecschedulinggatesindex">schedulingGates</a></b></td>
        <td>[]object</td>
        <td>
...
completed.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspeccontainersindexrestartpolicyrulesindex">restartPolicyRules</a></b></td>
        <td>[]object</td>
        <td>
...
spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspeccontainersindexenvindexvaluefromfilekeyref">fileKeyRef</a></b></td>
        <td>object</td>
        <td>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspeccontainersindexlifecyclepoststartsleep">sleep</a></b></td>
        <td>object</td>
        <td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.containers[index].lifecycle.postStart.sleep
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspeccontainersindexlifecyclepoststart)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspeccontainersindexlifecycleprestopsleep">sleep</a></b></td>
        <td>object</td>
        <td>
          Sleep represents a duration that the container should sleep.<br/>
        </td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.containers[index].lifecycle.preStop.sleep
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspeccontainersindexlifecycleprestop)</sup></sup>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.containers[index].resizePolicy[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspeccontainersindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspeccontainersindexresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims,
that are used by this container.
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.containers[index].resources.claims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspeccontainersindexresources)</sup></sup>
...
container.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspeccontainersindexrestartpolicyrulesindexexitcodes">exitCodes</a></b></td>
        <td>object</td>
        <td>
...
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspeccontainersindexrestartpolicyrulesindex)</sup></sup>
...
Note that this field cannot be set when spec.os.name is windows.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspeccontainersindexsecuritycontextapparmorprofile">appArmorProfile</a></b></td>
        <td>object</td>
        <td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.containers[index].securityContext.appArmorProfile
...
More info: https://kubernetes.io/docs/concepts/containers/images#updating-images<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexresizepolicyindex">resizePolicy</a></b></td>
        <td>[]object</td>
        <td>
          Resources resize policy for the container.<br/>
        </td>
...
You cannot set this field on ephemeral containers.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexrestartpolicyrulesindex">restartPolicyRules</a></b></td>
        <td>[]object</td>
        <td>
          Represents a list of rules to be checked to determine if the
...
spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexenvindexvaluefromfilekeyref">fileKeyRef</a></b></td>
        <td>object</td>
        <td>
          FileKeyRef selects a key of the env file.
Requires the EnvFiles feature gate to be enabled.<br/>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexlifecyclepoststartsleep">sleep</a></b></td>
        <td>object</td>
        <td>
          Sleep represents a duration that the container should sleep.<br/>
        </td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.ephemeralContainers[index].lifecycle.postStart.sleep
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexlifecyclepoststart)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexlifecycleprestopsleep">sleep</a></b></td>
        <td>object</td>
        <td>
          Sleep represents a duration that the container should sleep.<br/>
        </td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.ephemeralContainers[index].lifecycle.preStop.sleep
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexlifecycleprestop)</sup></sup>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.ephemeralContainers[index].resizePolicy[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims,
that are used by this container.
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.ephemeralContainers[index].resources.claims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexresources)</sup></sup>
...
container.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexrestartpolicyrulesindexexitcodes">exitCodes</a></b></td>
        <td>object</td>
        <td>
          Represents the exit codes to check on container exits.<br/>
        </td>
...
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexrestartpolicyrulesindex)</sup></sup>
...
Note that this field cannot be set when spec.os.name is windows.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecephemeralcontainersindexsecuritycontextapparmorprofile">appArmorProfile</a></b></td>
        <td>object</td>
        <td>
          appArmorProfile is the AppArmor options to use by this container. If set, this profile
overrides the pod's appArmorProfile.
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.ephemeralContainers[index].securityContext.appArmorProfile
...
completed.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecinitcontainersindexrestartpolicyrulesindex">restartPolicyRules</a></b></td>
        <td>[]object</td>
        <td>
          Represents a list of rules to be checked to determine if the
container should be restarted on exit. The rules are evaluated in
...
spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP, status.podIPs.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecinitcontainersindexenvindexvaluefromfilekeyref">fileKeyRef</a></b></td>
        <td>object</td>
        <td>
          FileKeyRef selects a key of the env file.
Requires the EnvFiles feature gate to be enabled.<br/>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecinitcontainersindexlifecyclepoststartsleep">sleep</a></b></td>
        <td>object</td>
        <td>
          Sleep represents a duration that the container should sleep.<br/>
        </td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.initContainers[index].lifecycle.postStart.sleep
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecinitcontainersindexlifecyclepoststart)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecinitcontainersindexlifecycleprestopsleep">sleep</a></b></td>
        <td>object</td>
        <td>
          Sleep represents a duration that the container should sleep.<br/>
        </td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.initContainers[index].lifecycle.preStop.sleep
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecinitcontainersindexlifecycleprestop)</sup></sup>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.initContainers[index].resizePolicy[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecinitcontainersindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecinitcontainersindexresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims,
that are used by this container.
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.initContainers[index].resources.claims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecinitcontainersindexresources)</sup></sup>
...
container.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecinitcontainersindexrestartpolicyrulesindexexitcodes">exitCodes</a></b></td>
        <td>object</td>
        <td>
          Represents the exit codes to check on container exits.<br/>
        </td>
...
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecinitcontainersindexrestartpolicyrulesindex)</sup></sup>
...
Note that this field cannot be set when spec.os.name is windows.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecinitcontainersindexsecuritycontextapparmorprofile">appArmorProfile</a></b></td>
        <td>object</td>
        <td>
          appArmorProfile is the AppArmor options to use by this container. If set, this profile
overrides the pod's appArmorProfile.
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.initContainers[index].securityContext.appArmorProfile
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.resourceClaims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspec)</sup></sup>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.resources
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims,
that are used by this container.
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.resources.claims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecresources)</sup></sup>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.schedulingGates[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspec)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecsecuritycontextapparmorprofile">appArmorProfile</a></b></td>
        <td>object</td>
        <td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.securityContext.appArmorProfile
...
More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecvolumesindeximage">image</a></b></td>
        <td>object</td>
        <td>
          image represents an OCI object (a container image or artifact) pulled and mounted on the kubelet's host machine.
The volume is resolved at pod startup depending on which PullPolicy value is provided:
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.volumes[index].image
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecvolumesindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecvolumesindexprojectedsourcesindexclustertrustbundle">clusterTrustBundle</a></b></td>
        <td>object</td>
        <td>
          ClusterTrustBundle allows a pod to access the `.spec.trustBundle` field
of ClusterTrustBundle objects in an auto-updating file.
...
may change the order over time.<br/>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecvolumesindexprojectedsourcesindexpodcertificate">podCertificate</a></b></td>
        <td>object</td>
        <td>
          Projects an auto-rotating credential bundle (private key and certificate
chain) that the pod can use either as a TLS client or server.
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.volumes[index].projected.sources[index].clusterTrustBundle
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecvolumesindexprojectedsourcesindexclustertrustbundlelabelselector">labelSelector</a></b></td>
        <td>object</td>
        <td>
          Select all ClusterTrustBundles that match this label selector.  Only has
effect if signerName is set.  Mutually-exclusive with name.  If unset,
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.volumes[index].projected.sources[index].clusterTrustBundle.labelSelector
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecvolumesindexprojectedsourcesindexclustertrustbundle)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecpodtemplatespecspecvolumesindexprojectedsourcesindexclustertrustbundlelabelselectormatchexpressionsindex">matchExpressions</a></b></td>
        <td>[]object</td>
        <td>
          matchExpressions is a list of label selector requirements. The requirements are ANDed.<br/>
        </td>
...
#### CassandraDatacenter.spec.podTemplateSpec.spec.volumes[index].projected.sources[index].clusterTrustBundle.labelSelector.matchExpressions[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecpodtemplatespecspecvolumesindexprojectedsourcesindexclustertrustbundlelabelselector)</sup></sup>
...
PodAntiAffinity rules, set allowMultipleWorkers to true, otherwise defaults are applied and then these Affinity settings are merged.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>nodeAffinityLabels</b></td>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims,
that are used by this container.
...
#### CassandraDatacenter.spec.resources.claims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecresources)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#cassandradatacenterspecsystemloggerresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims,
that are used by this container.
...
#### CassandraDatacenter.spec.systemLoggerResources.claims[index]
<sup><sup>[↩ Parent](#cassandradatacenterspecsystemloggerresources)</sup></sup>
...
were last upserted to the management API<br/>
          <br/>
            <i>Format</i>: date-time<br/>
        </td>
        <td>false</td>
...
The "Allow" property is only valid if all the other active Tasks have "Allow" as well.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
the task will be executed immediately.<br/>
          <br/>
            <i>Format</i>: date-time<br/>
        </td>
        <td>false</td>
...
the task will not be cleaned up by the cass-operator. If unset, the default time (86400s) is used.<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
...
referenced in this map will not be moved.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
The completion time is only set when the job finishes successfully.<br/>
          <br/>
            <i>Format</i>: date-time<br/>
        </td>
        <td>false</td>
...
from suspension. It is represented in RFC3339 form and is in UTC.<br/>
          <br/>
            <i>Format</i>: date-time<br/>
        </td>
        <td>false</td>
...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#scheduledtaskspec">spec</a></b></td>
        <td>object</td>
        <td>
          ScheduledTaskSpec defines the desired state of ScheduledTask<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b><a href="#scheduledtaskstatus">status</a></b></td>
        <td>object</td>
        <td>
          MedusaTaskStatus defines the observed state of MedusaTask<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
...
#### ScheduledTask.spec
<sup><sup>[↩ Parent](#scheduledtask)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#scheduledtaskspectaskdetails">taskDetails</a></b></td>
        <td>object</td>
        <td>
          <br/>
        </td>
...
#### ScheduledTask.spec.taskDetails
<sup><sup>[↩ Parent](#scheduledtaskspec)</sup></sup>
...
The "Allow" property is only valid if all the other active Tasks have "Allow" as well.<br/>
        ...
        <td><b><a href="#scheduledtaskspectaskdetailsdatacenter">datacenter</a></b></td>
        <td>object</td>
        <td>
          Which datacenter this task is targeting. Note, this must be a datacenter which the current cass-operator
can access<br/>
        ...
        <td><b><a href="#scheduledtaskspectaskdetailsjobsindex">jobs</a></b></td>
        <td>[]object</td>
        <td>
          Jobs defines the jobs this task will execute (and their order)<br/>
        </td>
...
If not set or set to 0 defaults to 1.<br/>
        ...
        <td>string</td>
        <td>
          Name of the task. Always populated.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>restartPolicy</b></td>
...
#### ScheduledTask.spec.taskDetails.datacenter
<sup><sup>[↩ Parent](#scheduledtaskspectaskdetails)</sup></sup>
...
#### ScheduledTask.spec.taskDetails.jobs[index]
<sup><sup>[↩ Parent](#scheduledtaskspectaskdetails)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#scheduledtaskspectaskdetailsjobsindexargs">args</a></b></td>
        <td>object</td>
        <td>
          Arguments are additional parameters for the command<br/>
        </td>
...
#### ScheduledTask.spec.taskDetails.jobs[index].args
<sup><sup>[↩ Parent](#scheduledtaskspectaskdetailsjobsindex)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b>lastExecution</b></td>
        <td>string</td>
        <td>
          LastExecution tells when the backup was last time taken. If empty, the backup has never been taken<br/>
          <br/>
            <i>Format</i>: date-time<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>nextSchedule</b></td>
        <td>string</td>
        <td>
