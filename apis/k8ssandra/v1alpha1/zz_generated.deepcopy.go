...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuditWriterOptions) DeepCopyInto(out *AuditWriterOptions) {
	*out = *in
	if in.Mode != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuditWriterOptions.
func (in *AuditWriterOptions) DeepCopy() *AuditWriterOptions {
	if in == nil {
		return nil
	}
	out := new(AuditWriterOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DseYaml) DeepCopyInto(out *DseYaml) {
	*out = *in
	...
	if in.AuditWriterOptions != nil {
		in, out := &in.AuditWriterOptions, &out.AuditWriterOptions
		*out = new(AuditWriterOptions)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.IndexOptions != nil {
		in, out := &in.IndexOptions, &out.IndexOptions
