...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CassandraDatacenterMeta) DeepCopyInto(out *CassandraDatacenterMeta) {
	*out = *in
	if in.Resource != nil {
	...
	if in.ServiceConfig != nil {
		...
		*out = new(v1beta1.ServiceConfig)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraDatacenterMeta.
func (in *CassandraDatacenterMeta) DeepCopy() *CassandraDatacenterMeta {
	if in == nil {
		return nil
	}
	out := new(CassandraDatacenterMeta)
	in.DeepCopyInto(out)
	return out
}
