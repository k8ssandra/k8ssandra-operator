...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *K8ssandraClusterCustomValidator) DeepCopyInto(out *K8ssandraClusterCustomValidator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new K8ssandraClusterCustomValidator.
func (in *K8ssandraClusterCustomValidator) DeepCopy() *K8ssandraClusterCustomValidator {
	if in == nil {
		return nil
	}
	out := new(K8ssandraClusterCustomValidator)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Rebuild) DeepCopyInto(out *Rebuild) {
	*out = *in
	if in.DCReplication != nil {
		in, out := &in.DCReplication, &out.DCReplication
		*out = new(string)
		**out = **in
	}
	if in.SourceDC != nil {
		in, out := &in.SourceDC, &out.SourceDC
		*out = new(string)
		**out = **in
	}
