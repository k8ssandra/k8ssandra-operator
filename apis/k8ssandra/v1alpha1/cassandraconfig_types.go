...
type JvmOptions struct {
	...
	// +optional
	NettyTryReflectionSetAccessible *bool `json:"netty_try_reflection_set_accessible,omitempty" cass-config:">=4.x:jvm11-server-options/io_netty_try_reflection_set_accessible;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/io_netty_try_reflection_set_accessible"`
	...
	// +optional
	JdkAllowAttachSelf *bool `json:"jdk_allow_attach_self,omitempty" cass-config:">=4.x:jvm11-server-options/jdk_attach_allow_attach_self;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/jdk_attach_allow_attach_self"`
	...
	// +optional
	GarbageCollector *string `json:"gc,omitempty" cass-config:"^3.11.x:jvm-options/garbage_collector;>=4.x:jvm11-server-options/garbage_collector;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/garbage_collector"`
	...
	// +kubebuilder:validation:Maximum=100
	// +optional
	G1RSetUpdatingPauseTimePercent *int `json:"gc_g1_rset_updating_pause_time_percent,omitempty" cass-config:"^3.11.x:jvm-options/g1r_set_updating_pause_time_percent;>=4.x:jvm11-server-options/g1r_set_updating_pause_time_percent;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/g1r_set_updating_pause_time_percent"`
	...
	// +optional
	G1MaxGcPauseMs *int `json:"gc_g1_max_gc_pause_ms,omitempty" cass-config:"^3.11.x:jvm-options/max_gc_pause_millis;>=4.x:jvm11-server-options/max_gc_pause_millis;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/max_gc_pause_millis"`
	...
	// +kubebuilder:validation:Maximum=100
	// +optional
	G1InitiatingHeapOccupancyPercent *int `json:"gc_g1_initiating_heap_occupancy_percent,omitempty" cass-config:"^3.11.x:jvm-options/initiating_heap_occupancy_percent;>=4.x:jvm11-server-options/initiating_heap_occupancy_percent;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/initiating_heap_occupancy_percent"`
	...
	// +optional
	G1ParallelGcThreads *int `json:"gc_g1_parallel_threads,omitempty" cass-config:"^3.11.x:jvm-options/parallel_gc_threads;>=4.x:jvm11-server-options/parallel_gc_threads;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/parallel_gc_threads"`
	...
	// +optional
	G1ConcGcThreads *int `json:"gc_g1_conc_threads,omitempty" cass-config:"^3.11.x:jvm-options/conc_gc_threads;>=4.x:jvm11-server-options/conc_gc_threads;dse@>=6.8.x,hcd@>=1.x.x:jvm8-server-options/conc_gc_threads"`
