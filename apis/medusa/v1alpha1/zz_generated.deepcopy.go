...
func (in *MedusaClusterTemplate) DeepCopyInto(out *MedusaClusterTemplate) {
	*out = *in
	...
	if in.ReadinessProbeSettings != nil {
		in, out := &in.ReadinessProbeSettings, &out.ReadinessProbeSettings
		*out = new(ProbeSettings)
		**out = **in
	}
	if in.LivenessProbeSettings != nil {
		in, out := &in.LivenessProbeSettings, &out.LivenessProbeSettings
		*out = new(ProbeSettings)
		**out = **in
	}
}
