...
type PrometheusTelemetrySpec struct {
	// Enable the creation of Prometheus serviceMonitors for this resource (Cassandra or Stargate). True by default.
	// +optional
...
func (in *PrometheusTelemetrySpec) IsEnabled() bool {
