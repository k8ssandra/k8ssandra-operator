...
type ReaperTemplate struct {
	...
	// The default is "thelastpickle/cassandra-reaper:config-heap-size2".
	// +optional
	// +kubebuilder:default={repository:"thelastpickle",name:"cassandra-reaper",tag:"config-heap-size2"}
